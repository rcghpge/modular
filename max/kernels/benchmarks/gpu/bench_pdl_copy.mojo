...
fn bench_pdl_copy(mut b: Bench, *, length: Int, context: DeviceContext) raises:
    ...
    fn run_func() raises:
        for _ in range(10):
            context.enqueue_function[copy1, copy1](
                a_device,
                b_device,
                length,
                grid_dim=(grid_dim),
            ...
            context.enqueue_function[copy2, copy2](
                b_device,
                c_device,
                d_device,
                length,
...
fn bench_copy(mut b: Bench, *, length: Int, context: DeviceContext) raises:
    ...
    fn run_func() raises:
        for _ in range(10):
            context.enqueue_function[copy1_n, copy1_n](
                a_device,
                b_device,
                length,
                grid_dim=(grid_dim),
            ...
            context.enqueue_function[copy2_n, copy2_n](
                b_device,
                c_device,
                d_device,
                length,
