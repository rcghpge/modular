...
def main():
    ...
    comptime group = env_get_int["group", 32]()
    comptime use_causal_mask = env_get_bool["use_causal_mask", False]()
    ...
    var bench_and_verify = arg_parse("benchmark_and_verify", False)
