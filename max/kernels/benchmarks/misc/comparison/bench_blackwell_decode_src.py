...
if __name__ == "__main__":
    ...
    num_heads = int(arg_parse("num_heads", 4))
    num_kv_heads = int(arg_parse("num_kv_heads", 4))
    head_dim = int(arg_parse("head_dim", 4))
    page_size = int(arg_parse("page_size", 4))
    ...
    name = (
        f"Decode/batch_size={batch_size}/cache_len={cache_len}/"
