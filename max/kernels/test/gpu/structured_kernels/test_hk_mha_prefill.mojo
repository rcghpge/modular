...
# ===----------------------------------------------------------------------=== #
"""GPU test for HKMhaPrefill single-warp main loop.
...
comptime NUM_TILES = 8  # HK kernel.cpp prologue requires >= 4 (loads K[0..2], V[0..1])
comptime SEQ_LEN = BM
...
def main() raises:
    print("=" * 60)
    print("HKMhaPrefill main-loop GPU test")
    print("=" * 60)
