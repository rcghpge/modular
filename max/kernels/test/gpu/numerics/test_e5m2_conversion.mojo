...
# CHECK: 0.0, 1.52587890625e-05, 3.0517578125e-05, 4.57763671875e-05, 6.103515625e-05, 7.62939453125e-05, 9.1552734375e-05, 0.0001068115234375,
# CHECK: 0.0001220703125, 0.000152587890625, 0.00018310546875, 0.000213623046875, 0.000244140625, 0.00030517578125, 0.0003662109375, 0.00042724609375,
# CHECK: 0.00048828125, 0.0006103515625, 0.000732421875, 0.0008544921875, 0.0009765625, 0.001220703125, 0.00146484375, 0.001708984375,
# CHECK: 0.001953125, 0.00244140625, 0.0029296875, 0.00341796875, 0.00390625, 0.0048828125, 0.005859375, 0.0068359375,
...
# CHECK: -8192.0, -10240.0, -12288.0, -14336.0, -16384.0, -20480.0, -24576.0, -28672.0,
# CHECK: -32768.0, -40960.0, -49152.0, -57344.0, -inf, nan, nan, nan,
def test_simd_e5m2_to_f16_ptx_path(ctx: DeviceContext) raises:
    ...
    comptime kernel = test_simd_float8[DType.float8_e5m2, M, DType.float16]
...
# CHECK: -8192.0, -10240.0, -12288.0, -14336.0, -16384.0, -20480.0, -24576.0, -28672.0,
# CHECK: -32768.0, -40960.0, -49152.0, -57344.0, -inf, nan, nan, nan,
def test_simd_e5m2_to_f32_ptx_path(ctx: DeviceContext) raises:
    ...
    comptime kernel = test_simd_float8[DType.float8_e5m2, M, DType.float32]
    ctx.enqueue_function_experimental[kernel](
        e5m2_simd, grid_dim=1, block_dim=1
    )
    ctx.synchronize()
...
# CHECK: 256.0, 256.0, 256.0, 256.0, 256.0, 256.0, 256.0, 256.0,
# CHECK: 256.0, 256.0, 256.0, 256.0, 256.0, 256.0, 256.0, 256.0,
def test_simd_f32_to_e5m2_ptx_path(ctx: DeviceContext) raises:
