...
"""Bit-exact-ish correctness test for SM100 MHA with FP8 KV cache (d=512) — DECODE.

Decode-only sibling of `test_mha_sm100_fp8_kv_d512_prefill.mojo`. Both
...
At `seq_len=1` with head_dim=512 on B200, `flash_attention` lands in
...
Gemma4-global shape: n_kv_heads=4, head_dim=512.
...
def main() raises:
    with DeviceContext() as ctx:
        ...
        print("test_mha_sm100_fp8_kv_d512_decode: ALL PASSED")
