...
fn test_block_scaled_nvfp_gemv[
    out_dtype: DType,
    in_dtype: DType,
    transpose_b: Bool,
](
    ...
    print("M:", M, "N:", N, "K:", K, "tensor_sf:", tensor_sf)
    ...
    for idx0 in range(align_up(m.value, SF_MN_GROUP_SIZE)):
        for idx1 in range(
            0,
            align_up(k.value, NVFP4_SF_VECTOR_SIZE * SF_ATOM_K),
            NVFP4_SF_VECTOR_SIZE,
        ):
...
fn main() raises:
    with DeviceContext() as ctx:
        test_block_scaled_nvfp_gemv[
            DType.bfloat16,
            DType.float4_e2m1fn,
            True,
        ](ctx, dynamic(1), static[7168](), static[16384]())
        test_block_scaled_nvfp_gemv[
            DType.bfloat16,
            DType.float4_e2m1fn,
            True,
        ](ctx, dynamic(1), static[4096](), static[7168]())
        test_block_scaled_nvfp_gemv[
            DType.bfloat16,
            DType.float4_e2m1fn,
            True,
        ](ctx, dynamic(1), static[7168](), static[2048]())

        test_block_scaled_nvfp_gemv[DType.bfloat16, DType.float4_e2m1fn, True,](
            ctx,
            dynamic(1),
            static[128 + 16](),
            static[1024 + 16](),
        ...
        test_block_scaled_nvfp_gemv[
            ...
            DType.float4_e2m1fn,
            True,
        ](ctx, dynamic(1), static[128 + 16](), static[256 + 64]())
        test_block_scaled_nvfp_gemv[DType.bfloat16, DType.float4_e2m1fn, True,](
            ctx,
            dynamic(1),
            static[8192](),
        ...
        test_block_scaled_nvfp_gemv[
            ...
            DType.float4_e2m1fn,
            True,
        ](ctx, dynamic(1), static[65536 * 2 + 64](), static[4096]())
