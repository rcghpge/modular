...
def _get_cudnn_meta(
    ...
    return new_ptr_meta.as_any_origin()
...
def _conv_miopen[
    ...
    if (
        ...
        check_miopen_error(
            miopenSetTensorDescriptorV2(
                ...
                Int32(tensor_rank),
                input_shape.unsafe_ptr().as_immutable().as_any_origin(),
                input_strides.unsafe_ptr().as_immutable().as_any_origin(),
            )
        )
        ...
        check_miopen_error(
            miopenSetTensorDescriptorV2(
                ...
                Int32(tensor_rank),
                filter_shape.unsafe_ptr().as_immutable().as_any_origin(),
                filter_strides.unsafe_ptr().as_immutable().as_any_origin(),
            )
        )
        ...
        check_miopen_error(
            miopenSetTensorDescriptorV2(
                ...
                Int32(tensor_rank),
                output_shape.unsafe_ptr().as_immutable().as_any_origin(),
                output_strides.unsafe_ptr().as_immutable().as_any_origin(),
            )
        )
        ...
        check_miopen_error(
            miopenInitConvolutionNdDescriptor(
                ptr_meta[].conv_desc,
                Int32(conv_rank),
                padding.unsafe_ptr().as_immutable().as_any_origin(),
                stride.unsafe_ptr().as_immutable().as_any_origin(),
                dilation.unsafe_ptr().as_immutable().as_any_origin(),
        ...
        check_miopen_error(
            miopenConvolutionForwardGetWorkSpaceSize(
                ...
                ptr_meta[].conv_desc,
                ptr_meta[].output_desc,
                UnsafePointer(to=workspace_size).as_any_origin(),
            )
        )
        ...
        check_miopen_error(
            miopenFindConvolutionForwardAlgorithm(
                ...
                output.ptr.bitcast[NoneType](),
                Int32(1),
                UnsafePointer(to=returned_count).as_any_origin(),
                UnsafePointer(to=perf).as_any_origin(),
    ...
    check_miopen_error(
        miopenConvolutionForward(
            ptr_meta[].handle,
            UnsafePointer(to=alpha).as_immutable().as_any_origin(),
            ptr_meta[].input_desc,
            input.ptr.bitcast[NoneType](),
            ptr_meta[].filter_desc,
            filter_frsc_ptr.bitcast[NoneType](),
            ptr_meta[].conv_desc,
            ptr_meta[].algo,
            UnsafePointer(to=beta).as_immutable().as_any_origin(),
            ptr_meta[].output_desc,
            output.ptr.bitcast[NoneType](),
...
def conv_gpu[
    ...
    if has_asymmetric_padding:
        ...
        var padded_input_lt = LayoutTensor[
            ...
            padded_device_buffer.as_any_origin(),
        ...
        comptime if filter_is_fcrs:
            ...
            comptime if maybe_epilogue_func:
                ...
                var output_tmp_lt = LayoutTensor[
                    ...
                    output_tmp_data.unsafe_ptr().as_any_origin(),
