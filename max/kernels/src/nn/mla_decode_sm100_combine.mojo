...
fn mla_combine_kernel[
    ...
    head_dim: Int,
    num_splits: Int,
](params: CombineParams[output_type, accum_type, num_splits]):
    # PDL: Wait for the MLA decode kernel (dependent kernel) to complete.
    wait_on_dependent_grids()

    comptime ParamsType = CombineParams[output_type, accum_type, num_splits]
    ...
    # =========================================================================
    var out_ptr = params.output_ptr + out_row * params.out_stride_row
...
fn launch_mla_combine_kernel[
    ...
    ctx.enqueue_function[
        mla_combine_kernel[output_type, accum_type, head_dim, num_splits],
        mla_combine_kernel[output_type, accum_type, head_dim, num_splits],
    ](
        params,
        grid_dim=grid_dim,
...
fn mla_decode_combine_partial_outputs[
    ...
    launch_mla_combine_kernel[output_type, accum_type, head_dim, num_splits](
        out_accum_split,
        lse_accum_split,
        output,
        batch_size,
