        ...
        if WarpRole.is_main_load():
            ...
            var tensormap_mgr = Self.TensormapManagerType(
                smem=GroupedTensormapSmem.from_smem(
                    UnsafePointer(to=smem.tensormap_a).as_any_origin(),
                    UnsafePointer(to=smem.tensormap_b).as_any_origin(),
                    UnsafePointer(to=smem.tensormap_sfa).as_any_origin(),
                    UnsafePointer(to=smem.tensormap_sfb).as_any_origin(),
                    UnsafePointer(to=smem.tensormap_c).as_any_origin(),
                ),
            )
