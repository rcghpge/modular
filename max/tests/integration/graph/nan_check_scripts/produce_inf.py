...
# ===----------------------------------------------------------------------=== #
"""Subprocess script: build a div graph and execute with inputs that produce Inf.

Inputs: [1.0, 2.0, 3.0, 4.0] / [0.0, 0.0, 1.0, 1.0]
Expected output: [Inf, Inf, 3.0, 4.0]

With max-debug.nan-check enabled, this should abort with an Inf diagnostic.
...
with Graph("inf_graph", input_types=[input_type, input_type]) as g:
...
# 1.0 / 0.0 = Inf at indices 0 and 1
