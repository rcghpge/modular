...
# ===----------------------------------------------------------------------=== #
"""Subprocess script: build a div graph and execute with inputs that produce NaN.
...
with Graph("nan_graph", input_types=[input_type, input_type]) as g:
...
# 0.0 / 0.0 = NaN at indices 0 and 2
