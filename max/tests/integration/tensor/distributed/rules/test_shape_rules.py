...
#  Split
#
#  Reshape and broadcast_to are no longer rule-based — they live in
#  ``functional.shape_ops`` with custom dispatch. End-to-end coverage is
#  in ``functional/_shape.py`` (``_Reshape``, ``_BroadcastTo``).
# ═════════════════════════════════════════════════════════════════════════
