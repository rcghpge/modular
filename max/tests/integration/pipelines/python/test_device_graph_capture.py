...
from max.tests.integration.pipelines.python.test_common.mocks.pipeline_config import (
    DummyPipelineConfig,
    mock_huggingface_config,
)
from max.tests.integration.pipelines.python.test_common.mocks.pipeline_model import (
    MockModelInputs,
    MockPipelineModel,
)
