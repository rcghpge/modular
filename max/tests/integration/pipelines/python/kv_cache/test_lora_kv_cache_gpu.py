...
# ===----------------------------------------------------------------------=== #
"""Unit tests for LoRA KV cache kernels with PyTorch reference implementations."""
...
from max.nn.kernels import kv_cache_ragged_2m_iadd, sgmv_qkv_lora_kernel
...
def dump_kv_cache_to_torch(
    ...
    Returns list of tensors, each with shape [seq_len, n_kv_heads * head_dim].
    """
    ...
    # Select K or V: [total_num_pages, num_layers, page_size, n_heads, head_dim]
