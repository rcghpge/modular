...
def test_text_generation_pipeline__empty_batches(
    ...
    To run this test:
    ```
    bazel test SDK/integration-test/API/python/pipelines/text_generation_pipeline:test_empty_batches --test_output=all
    ```
    """
    ...
    inputs: TextGenerationInputs[TextContext] = TextGenerationInputs(
        batches=cast(list[dict[RequestID, TextContext]], [{}, {}]),
        num_steps=1,
    )
