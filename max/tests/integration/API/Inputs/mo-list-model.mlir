mo.graph @append(%0: !mo.list<!mo.tensor<?,f32>>, %1: !mo.tensor<[5], f32>) -> (!mo.list<!mo.tensor<?, f32>>) no_inline attributes {argument_names = ["input_list", "input_tensor"], result_names = ["output_list"]} {
