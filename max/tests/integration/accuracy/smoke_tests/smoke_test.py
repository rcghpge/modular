...
MODEL_RECIPES = CaseInsensitiveDict({
    ...
    "nvidia/Kimi-K2.6-NVFP4__eagle_tiered_kvconnector_tpep": "max/pipelines/architectures/kimik2_5/recipes/nvfp4_kimi_k2_6_eagle_tiered_kvconnector_tpep_8x_b200.yaml",
