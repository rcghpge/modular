...
from .model_config import QwenImageConfig
from .qwen_image import QwenImageTransformer2DModel


class QwenImageTransformerModel(ComponentModel):
    def __init__(
        self,
        config: dict[str, Any],
        ...
        self.config = QwenImageConfig.generate(
            config,
            encoding,
            devices,
        )
