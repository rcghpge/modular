...
# V3 uses "language_model." prefix to match the module hierarchy.
EXAONE_SAFETENSOR_MAPPING = {
    "transformer.wte": "language_model.embed_tokens",
    "transformer.h": "language_model.layers",
    ...
    "transformer.ln_f": "language_model.norm",
