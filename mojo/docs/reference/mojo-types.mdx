...
[Mojo numeric types](/mojo/reference/mojo-numeric-types).

<!-- markdownlint-disable MD013 -->

| Type                                                                                | What it is                                                      |
|-------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| [`IntLiteral`](/mojo/reference/mojo-numeric-types#int-literal)                      | Arbitrary-precision integer. Compile-time only.                 |
| [`FloatLiteral`](/mojo/reference/mojo-numeric-types#float-literal)                  | Arbitrary-precision float. Compile-time only.                   |
| [`Int`](/mojo/reference/mojo-numeric-types#int)                                     | Signed integer, system word size. Its own struct.               |
| [`SIMD`](/mojo/reference/mojo-numeric-types#simd)                                   | Fixed-size vector of numeric values. Mojo's numeric foundation. |
| [`DType`](/mojo/reference/mojo-numeric-types#dtype)                                 | Enumeration of numeric type identifiers. Used as a parameter.   |
| [`Scalar`](/mojo/reference/mojo-numeric-types#scalar)                               | Single numeric value. Alias for `SIMD[dtype, 1]`.               |
| [`UInt`](/mojo/reference/mojo-numeric-types#uint)                                   | Unsigned integer, system word size. A `Scalar` alias.           |
| [`Int8`-`Int256`](/mojo/reference/mojo-numeric-types#sized-integer-types)           | Fixed-width signed integers. `Scalar` aliases.                  |
| [`UInt8`-`UInt256`, `Byte`](/mojo/reference/mojo-numeric-types#sized-integer-types) | Fixed-width unsigned integers. `Scalar` aliases.                |
| [`Float16`-`Float64`](/mojo/reference/mojo-numeric-types#floating-point-types)      | IEEE 754 floating-point types. `Scalar` aliases.                |
| [`BFloat16`](/mojo/reference/mojo-numeric-types#bfloat16)                           | Brain floating-point (16-bit). A `Scalar` alias.                |
| [`Float8_*`, `Float4_*`](/mojo/reference/mojo-numeric-types#floating-point-types)   | AI-optimized low-precision floats. `Scalar` aliases.            |
