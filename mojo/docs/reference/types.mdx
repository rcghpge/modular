...
<!-- VERIFIED: prelude/__init__.mojo (auto-import set; the compiler imports
     ...
     collections/string/string_slice.mojo (StaticString, StringSlice),
     memory/span.mojo (non-owning view), collections/optional.mojo
     (value() aborts on empty), collections/inline_array.mojo,
...
| [`StringSlice`](/docs/std/collections/string/string_slice/StringSlice/)   | Non-owning view into existing UTF-8 data.    |
| [`StaticString`](/docs/std/collections/string/string_slice/#staticstring) | A `StringSlice` over static, read-only data. |
...
| [`InlineArray`](/docs/std/collections/inline_array/InlineArray/) | Fixed-size array stored inline, with no heap allocation.    |
...
| Type                                                              | What it is                                                                  |
|-------------------------------------------------------------------|-----------------------------------------------------------------------------|
| [`Pointer`](/docs/std/memory/pointer/Pointer/)                    | Non-nullable safe pointer to a single value.                                |
| [`UnsafePointer`](/docs/std/memory/unsafe_pointer/UnsafePointer/) | Raw pointer. No nullability or safety guarantees. Manual memory management. |
| [`Span`](/docs/std/memory/span/Span/)                             | Non-owning view of contiguous data.                                         |
| [`AddressSpace`](/docs/std/memory/pointer/AddressSpace/)          | Identifies where memory lives, such as CPU or GPU.                          |
...
For allocation, pointer arithmetic, and lifetimes, see
