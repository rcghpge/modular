...
<!-- VERIFICATION: This page contains reference claims (precedence,
     ...
     Precedence + associativity:
       KGEN/lib/MojoParser/ParserBase.h (Precedence enum)
       KGEN/lib/MojoParser/ParserExprs.cpp (InfixInfo::get)

     Equatable/Comparable defaults:
       oss/modular/mojo/stdlib/std/builtin/comparable.mojo

     Identifiable defaults:
       oss/modular/mojo/stdlib/std/builtin/identifiable.mojo

     Powable trait:
       oss/modular/mojo/stdlib/std/math/math.mojo (search "trait Powable")
