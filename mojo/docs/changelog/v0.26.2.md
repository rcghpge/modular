...
- Added a new [Mojo tips for Python devs](/mojo/manual/python-to-mojo) page
...
- Added a new
  [Instance initialization deep dive](/mojo/manual/lifecycle/object-initialization)
...
- Added a new [Generics](/mojo/manual/generics/generics) page to the Mojo
...
- Restructured and expanded the [metaprogramming](/mojo/manual/metaprogramming/)
...
- Updated the [Jupyter Notebooks](/mojo/tools/notebooks) page with Apple
...
- Mojo now supports **conditional trait conformances** on struct declarations.
  ...
  [`Bool`](/mojo/std/builtin/bool/Bool/)-typed parameter
  expression. For example,
  [`List`](/mojo/std/collections/list/List/) now uses this to
  conditionally conform to
  [`Equatable`](/mojo/std/builtin/comparable/Equatable/) and
  [`Writable`](/mojo/std/format/Writable/) only when its
  element type does:
  ...
  **Current limitations**: Conditional conformance to
  ...
  [`TrivialRegisterPassable`](/mojo/std/builtin/value/TrivialRegisterPassable/),
  and
...
- Mojo now supports t-strings (template strings) for building structured
  ...
  [`TString`](/mojo/std/format/tstring/TString/) value that
...
- Mojo now supports a standalone `assert` statement, similar to Python's
  ...
  `String`, [`Int`](/mojo/std/builtin/int/Int/), etc.). Under
  the hood, `assert` desugars to a call to
  [`debug_assert()`](/mojo/std/builtin/debug_assert/debug_assert/),
  so it respects the
...
- Mojo now supports the
  [`@align`](/mojo/manual/decorators/align)`(N)` decorator to
...
- As part of "init unification", the `__moveinit__()` and
...
- As part of init unification, the `__moveinit__is_trivial` and
  ...
  [`Copyable`](/mojo/std/builtin/value/Copyable/) have been
  renamed
...
- Homogeneous variadic parameters are now passed with the
  [`VariadicParamList`](/mojo/std/builtin/variadics/VariadicParamList/)
...
- `trait` declarations no longer automatically inherit from
  ...
  Previously, the
  [`@explicit_destroy`](/mojo/manual/decorators/explicit-destroy)
...
- [`Dict`](/mojo/std/collections/dict/Dict/) now uses real
...
- Standard library types now use conditional conformances, replacing previous
  ...
  - [`Deque`](/mojo/std/collections/deque/Deque/):
    `Equatable`,
    [`Hashable`](/mojo/std/hashlib/hash/Hashable/), `Writable`
  ...
  - [`Set`](/mojo/std/collections/set/Set/): `Copyable`,
    [`Comparable`](/mojo/std/builtin/comparable/Comparable/),
    `Equatable`, `Hashable`, `Writable`
  - [`Tuple`](/mojo/std/builtin/tuple/Tuple/): `Copyable`,
    `Equatable`, `Hashable`, `ImplicitlyCopyable`, `Writable`
  - [`Variant`](/mojo/std/utils/variant/Variant/): `Writable`
...
- [`StaticTuple`](/mojo/std/utils/static_tuple/StaticTuple/)
  now supports comparison operators.
  `__eq__()`/`__ne__()` are
...
- [`Set.pop()`](/mojo/std/collections/set/Set/#pop) now uses
  [`Dict.popitem()`](/mojo/std/collections/dict/Dict/#popitem)
...
- The [`itertools`](/mojo/std/itertools/) module now includes
  three new iterator combinators:
  - [`cycle(iterable)`](/mojo/std/itertools/itertools/cycle/):
    Creates an iterator that cycles through elements
    indefinitely
  - [`take_while[predicate](iterable)`](/mojo/std/itertools/itertools/take_while/):
    Yields elements while the predicate returns True
  - [`drop_while[predicate](iterable)`](/mojo/std/itertools/itertools/drop_while/):
    Drops elements while the predicate returns True, then
    yields the rest
...
- The `StringSlice` constructor from `String` now propagates mutability. If you
  ...
  `StringSlice`. The
  [`String.as_string_slice()`](/mojo/std/collections/string/string/String/#as_string_slice)
  method is now deprecated in
  favor of the `StringSlice(str)` constructor, and
  `String.as_string_slice_mut()`
  has been removed.

- [`String.ljust()`](/mojo/std/collections/string/string/String/#ljust),
...
- [`String.resize()`](/mojo/std/collections/string/string/String/#resize)
...
- `Bool` no longer conforms to the
  [`Indexer`](/mojo/std/builtin/int/Indexer/) trait. Previously,
  `Bool` could be
...
- Implicit conversions from `Int` to
  [`SIMD`](/mojo/std/builtin/simd/SIMD/) are now deprecated,
  and will be
  removed in a future version of Mojo. This includes deprecating
  conversions from
  ...
  in assisting with migrating your code to reflect this change.
...
- [`Int.__truediv__()`](/mojo/std/builtin/int/Int/#__truediv__)
...
- Documentation for
  [`SIMD.__round__()`](/mojo/std/builtin/simd/SIMD/#__round__)
  now clarifies the pre-existing behavior
  that ties are rounded to the nearest even, not away from zero.

- [`Int.write_padded()`](/mojo/std/builtin/int/Int/#write_padded)
...
- `SIMD` now has a `write_padded()` method for integral
  [`DType`](/mojo/std/builtin/dtype/DType/)s, matching the
...
- Added [`comb(n, k)`](/mojo/std/math/math/comb/) and
  [`perm(n, k)`](/mojo/std/math/math/perm/) to `std.math`,
  matching Python's
...
- The `builtin.math` module has been merged into
  [`math`](/mojo/std/math/). The traits
  [`Absable`](/mojo/std/math/math/Absable/),
  [`DivModable`](/mojo/std/math/math/DivModable/),
  [`Powable`](/mojo/std/math/math/Powable/),
  [`Roundable`](/mojo/std/math/math/Roundable/) and functions
  [`abs()`](/mojo/std/math/math/abs/),
  [`divmod()`](/mojo/std/math/math/divmod/), `max()`,
  `min()`, [`pow()`](/mojo/std/math/math/pow/),
  [`round()`](/mojo/std/math/math/round/) are now part of the
  `math` module and
...
- Added
  [`uninit_move_n()`](/mojo/std/memory/memory/uninit_move_n/),
  [`uninit_copy_n()`](/mojo/std/memory/memory/uninit_copy_n/),
  and
  [`destroy_n()`](/mojo/std/memory/memory/destroy_n/)
  functions to the [`memory`](/mojo/std/memory/) module for
...
- The [`Origin`](/mojo/std/builtin/type_aliases/Origin/)
...
- [`UnsafeMaybeUninit`](/mojo/std/memory/unsafe_maybe_uninit/UnsafeMaybeUninit/)
...
- [`Span`](/mojo/std/memory/span/Span/)`[T]` is no longer
...
- [`lane_group_sum()`](/mojo/std/gpu/primitives/warp/lane_group_sum/),
  [`lane_group_max()`](/mojo/std/gpu/primitives/warp/lane_group_max/),
  and
  [`lane_group_min()`](/mojo/std/gpu/primitives/warp/lane_group_min/)
  in
...
- [`TileTensor`](/mojo/kernels/layout/tile_tensor/TileTensor/) now supports
...
- The [`ffi`](/mojo/std/ffi/) module is now a top-level module
...
- Added
  [`UnsafeUnion`](/mojo/std/ffi/unsafe_union/UnsafeUnion/)`[*Ts]`,
...
- The `env_get_bool()`, `env_get_int()`, `env_get_string()`, and
  ...
  variables. The
  [`is_defined()`](/mojo/std/sys/defines/is_defined/) function
  has also moved to
...
- The [`testing`](/mojo/std/testing/) module now provides
  [`assert_equal`](/mojo/std/testing/testing/assert_equal/)
  and
  [`assert_not_equal`](/mojo/std/testing/testing/assert_not_equal/)
...
- Changed
  [`CompilationTarget.unsupported_target_error()`](/mojo/std/sys/info/CompilationTarget/#unsupported_target_error)
  to return `Never`
  and
...
- [`perf_counter_ns()`](/mojo/std/time/time/perf_counter_ns/) now returns
...
- The [`DimList`](/mojo/kernels/buffer/dimlist/DimList/) type has moved to
...
- [`StringSlice.find`](/mojo/std/collections/string/string_slice/StringSlice/#find):
  Fixed integer overflow bug in SIMD string search that
...
- [`LinkedList.reverse()`](/mojo/std/collections/linked_list/LinkedList/#reverse):
  Fixed missing `prev` pointer updates, which caused
