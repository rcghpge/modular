...
- Mojo now supports compile-time *keyword parameters*, in addition to existing
  support for
  [keyword arguments](/mojo/manual/parameters/#optional-parameters-and-keyword-parameters).
  For example:
  ...
  [Mojo Manual](/mojo/manual/parameters/#optional-parameters-and-keyword-parameters).
