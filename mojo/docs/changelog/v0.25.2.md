...
- Check out the new [GPU basics](/mojo/manual/gpu/fundamentals) section of the
  [Mojo Manual](/mojo/manual) and the
  [Get started with GPU programming with Mojo and the MAX Driver](/mojo/manual/gpu/intro-tutorial)
...
- Some APIs in the [`gpu`](/mojo/std/gpu/) package were enhanced to simplify
  ...
  - The [`gpu`](/mojo/std/gpu) package API documentation has been expanded,
    and API documentation for the [`layout`](/mojo/layout) package is
...
- The Mojo compile-time interpreter can now handle many more LLVM intrinsics,
  ...
  [`round()`](/mojo/std/math/math/round/) to be constant folded when used
...
- The [`round()`](/mojo/std/math/math/round/) function is now fixed to
...
- Several more packages are now documented:
  ...
  - [`layout`](/mojo/layout) package is underway, beginning with core
