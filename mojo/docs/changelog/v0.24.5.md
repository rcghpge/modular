...
- [`print()`](/mojo/std/io/io/print/) now requires that its arguments
  conform to the [`Formattable`](/mojo/std/format/Writable/) trait.
  This enables efficient stream-based writing by default, avoiding unnecessary
  intermediate String heap allocations.

- The new builtin [`input()`](/mojo/std/io/io/input/) function prints an
...
- [`mojo test`](/mojo/tools/testing) now uses the Mojo compiler for running unit
...
- [`builtin`](/mojo/std/builtin/) package:
  ...
  - The set of automatically imported entities (types, aliases, functions) into
    ...
    [`alignof()`](/mojo/std/sys/info/align_of/),
    [`bitcast()`](/mojo/std/memory/unsafe/bitcast),
    [`bitwidthof()`](/mojo/std/sys/info/bit_width_of/),
    [`external_call()`](/mojo/std/ffi/external_call/),
    [`simdwidthof()`](/mojo/std/sys/info/simd_width_of/), and
    [`sizeof()`](/mojo/std/sys/info/size_of/)).
...
- Input and output:
  ...
  - Added the builtin [`input()`](/mojo/std/io/io/input/) function, which
  ...
  - [`print()`](/mojo/std/io/io/print/) now requires that its arguments conform
    to the [`Formattable`](/mojo/std/format/Writable/) trait. This enables
...
- [`String`](/mojo/std/collections/string/string) and friends:
  ...
  - Added the `byte_length()` method to
    ...
    the [`String.__len__()`](/mojo/std/collections/string/string/String#__len__)
...
- [`UnsafePointer`](/mojo/std/memory/unsafe_pointer/UnsafePointer) and other
  ...
  - The global functions for working with `UnsafePointer` have transitioned to
    ...
    - `destroy_pointee(p)` =>
      [`p.destroy_pointee()`](/mojo/std/memory/unsafe_pointer/UnsafePointer#destroy_pointee)
    - `move_from_pointee(p)` =>
      [`p.take_pointee()`](/mojo/std/memory/unsafe_pointer/UnsafePointer#take_pointee)
    - `initialize_pointee_move(p, value)` =>
      [`p.init_pointee_move(value)`](/mojo/std/memory/unsafe_pointer/UnsafePointer#init_pointee_move)
    - `initialize_pointee_copy(p, value)` =>
      [`p.init_pointee_copy(value)`](/mojo/std/memory/unsafe_pointer/UnsafePointer#init_pointee_copy)
    - `move_pointee(src=p1, dst=p2)` =>
      [`p.move_pointee_into(p2)`](/mojo/std/memory/unsafe_pointer/UnsafePointer#move_pointee_into)
...
- Miscellaneous:
  ...
  - Mojo now has a [`UInt`](/mojo/std/builtin/simd/#uint) type for modeling
  ...
  - Added the [`c_char`](/mojo/std/ffi/#aliases) type alias in `sys.ffi`.
...
- [`mojo test`](/mojo/tools/testing) new features and changes:
...
- Removed the `SIMD.min()` and `SIMD.max()` methods. Identical functionality is
  available using the builtin [`min()`](/mojo/std/math/math/min/) and
  [`max()`](/mojo/std/math/math/max/) functions.
