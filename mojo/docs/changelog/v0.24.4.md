...
- New traits and related features:
  ...
  - Added built-in [`repr()`](/mojo/std/format/repr/repr/) function and
   `Representable` trait.
  ...
  - Added traits allowing user-defined types to be supported by various built-in
    ...
    |-----------------------------------------------|----------------------------------------------------|-----------------|
    | [`abs()`](/mojo/std/math/math/abs/)           | [`Absable`](/mojo/std/math/math/Absable/)          | `__abs__()`     |
    | [`pow()`](/mojo/std/math/math/pow/)           | [`Powable`](/mojo/std/math/math/Powable/)          | `__pow__()`     |
    | [`round()`](/mojo/std/math/math/round/)       | [`Roundable`](/mojo/std/math/math/Roundable/)      | `__round__()`   |
