...
- New traits and related features:
  ...
  - Added traits allowing user-defined types to be supported by various built-in
    ...
    [`Absable`](/mojo/std/math/math/Absable/) | `__abs__()` | |
    [`pow()`](/mojo/std/math/math/pow/) |
    [`Powable`](/mojo/std/math/math/Powable/) | `__pow__()` | |
    [`round()`](/mojo/std/math/math/round/) |
    [`Roundable`](/mojo/std/math/math/Roundable/) | `__round__()` | |
    [`math.ceil`](/mojo/std/math/math/ceil) | `math.Ceilable` | `__ceil__()` | |
    [`math.ceildiv`](/mojo/std/math/math/ceildiv) | `math.CeilDivable` <br/>
    `math.CeilDivableRaising` | `__ceildiv__()` | |
