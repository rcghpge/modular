...
`raise` statement with an [`Error`](/mojo/std/builtin/error/Error) instance
...
[`String`](/mojo/std/collections/string/string/String) or
[`StringLiteral`](/mojo/std/builtin/string_literal/StringLiteral) value, and
...
#2 0x000000010266468c std::builtin::error::Error::__init__[__mlir_type.!kgen.string](::StringLiteral[$0])_REMOVED_ARG open-source/max/mojo/stdlib/std/builtin/error.mojo:159:38
...
#6 0x000000010266468c std::builtin::_startup::__wrap_and_execute_raising_main[fn() raises -> None](::SIMD[::DType(int32), ::Int(1)],__mlir_type.!kgen.pointer<pointer<scalar<ui8>>>),main_func="stacktrace_error::main()" open-source/max/mojo/stdlib/std/builtin/_startup.mojo:88:18
#7 0x000000010266468c main open-source/max/mojo/stdlib/std/builtin/_startup.mojo:103:4
...
to get a [`StackTrace`](/mojo/std/builtin/error/StackTrace) instance.
`StackTrace` implements the [`Stringable`](/mojo/std/builtin/str/Stringable)
...
#2 0x00000001026d4694 std::builtin::error::Error::__init__[__mlir_type.!kgen.string](::StringLiteral[$0])_REMOVED_ARG open-source/max/mojo/stdlib/std/builtin/error.mojo:159:38
...
#6 0x00000001026d4694 std::builtin::_startup::__wrap_and_execute_raising_main[fn() raises -> None](::SIMD[::DType(int32), ::Int(1)],__mlir_type.!kgen.pointer<pointer<scalar<ui8>>>),main_func="stacktrace_error_capture::main()" open-source/max/mojo/stdlib/std/builtin/_startup.mojo:88:18
#7 0x00000001026d4694 main open-source/max/mojo/stdlib/std/builtin/_startup.mojo:103:4
```
...
implements the [`Writable`](/mojo/std/io/write/Writable) trait, so you can
pass it as an argument to the [`print()`](/mojo/std/builtin/io/print)
function if you'd like to print its error message to the console. It also
implements the [`Stringable`](/mojo/std/builtin/str/Stringable) trait, so you
