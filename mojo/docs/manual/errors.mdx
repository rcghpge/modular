...
#2 0x000000010266468c std::builtin::error::Error::__init__[__mlir_type.!kgen.string](::StringLiteral[$0])_REMOVED_ARG oss/modular/mojo/stdlib/std/builtin/error.mojo:159:38
...
#6 0x000000010266468c std::builtin::_startup::__wrap_and_execute_raising_main[fn() raises -> None](::SIMD[::DType(int32), ::Int(1)],__mlir_type.!kgen.pointer<pointer<scalar<ui8>>>),main_func="stacktrace_error::main()" oss/modular/mojo/stdlib/std/builtin/_startup.mojo:88:18
#7 0x000000010266468c main oss/modular/mojo/stdlib/std/builtin/_startup.mojo:103:4
...
#2 0x00000001026d4694 std::builtin::error::Error::__init__[__mlir_type.!kgen.string](::StringLiteral[$0])_REMOVED_ARG oss/modular/mojo/stdlib/std/builtin/error.mojo:159:38
...
#6 0x00000001026d4694 std::builtin::_startup::__wrap_and_execute_raising_main[fn() raises -> None](::SIMD[::DType(int32), ::Int(1)],__mlir_type.!kgen.pointer<pointer<scalar<ui8>>>),main_func="stacktrace_error_capture::main()" oss/modular/mojo/stdlib/std/builtin/_startup.mojo:88:18
#7 0x00000001026d4694 main oss/modular/mojo/stdlib/std/builtin/_startup.mojo:103:4
```
