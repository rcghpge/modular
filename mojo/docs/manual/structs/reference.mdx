...
[`UnsafePointer`](https://docs.modular.com/mojo/stdlib/memory/unsafe_pointer/UnsafePointer/).
...
[destructor](https://docs.modular.com/mojo/manual/lifecycle/death/).
...
* Learn more about **pointers and memory safety** in Mojo’s
  [UnsafePointer](https://docs.modular.com/mojo/stdlib/memory/unsafe_pointer/UnsafePointer/)
  and [lifetime and origin rules](https://docs.modular.com/mojo/manual/values/lifetimes/) guides.
* Learn more about how to **manage cleanup** in the Mojo
  [destructor](https://docs.modular.com/mojo/manual/lifecycle/death/) documentation.
* Learn more about [generic structures with traits](https://docs.modular.com/mojo/manual/traits/#generic-structs-with-traits)
