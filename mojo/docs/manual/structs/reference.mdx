...
[`MutExternalOrigin`](/mojo/manual/values/lifetimes/)
...
[Working with nullability](/mojo/manual/pointers/unsafe-pointers#working-with-nullability).
...
- Learn more about
  [generic structures with traits](/mojo/manual/traits/#generic-structs-with-traits)
