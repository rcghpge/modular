...
raise an error. When you call a function that _can_ raise an error from inside a
method that _can't_ raise an error, Mojo requires you to handle any errors, as
described in
