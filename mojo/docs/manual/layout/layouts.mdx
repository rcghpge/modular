...
- The [`Layout`](/docs/layout/layout/Layout/) struct describes an
...
- [`LayoutTensor`](/docs/layout/layout_tensor/LayoutTensor/) is a
  flexible tensor type that combines a `Layout` and a pointer to data.
- The [`IntTuple`](/docs/layout/int_tuple/IntTuple/) struct is a
...
also provides an [`idx2crd()`](/docs/layout/layout/Layout/#idx2crd)
...
[`IntTuple`](/docs/layout/int_tuple/IntTuple/) type. Each element of an
...
The [`int_tuple`](/docs/layout/int_tuple/) package provides a number of
functions for working with `IntTuple`. For example, it provides a
[`congruent()`](/docs/layout/int_tuple/congruent/) function for testing
...
[`row_major()`](/docs/layout/layout/Layout/#row_major) and
[`col_major()`](/docs/layout/layout/Layout/#col_major) static methods
...
[`tile_to_shape()`](/docs/layout/layout/tile_to_shape/) function.
...
[`blocked_product()`](/docs/layout/layout/blocked_product/) function. The
...
[`make_ordered_layout()`](/docs/layout/layout/make_ordered_layout/)
