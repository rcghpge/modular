...
- [`LayoutTensor`](/mojo/kernels/layout/layout_tensor/LayoutTensor) is a
...
also provides an [`idx2crd()`](/mojo/kernels/layout/layout/Layout#idx2crd)
...
[`col_major()`](/mojo/kernels/layout/layout/Layout/#col_major) static methods
