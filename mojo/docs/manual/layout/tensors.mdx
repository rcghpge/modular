...
A [`LayoutTensor`](/mojo/layout/layout_tensor/LayoutTensor/)
...
The
[`LayoutTensor.tile()`](/mojo/layout/layout_tensor/LayoutTensor/#tile)
...
The [`LayoutTensorIter`](/mojo/layout/layout_tensor/LayoutTensorIter/)
...
[`tiled_iterator()`](/mojo/layout/layout_tensor/LayoutTensor/#tiled_iterator)
...
The [`vectorize()`](/mojo/layout/layout_tensor/LayoutTensor/#vectorize)
...
- [`copy_from()`](/mojo/layout/layout_tensor/LayoutTensor/#copy_from)
  copies data from a source tensor to the current tensor, which may be in a
  different memory space.
- [`copy_from_async()`](/mojo/layout/layout_tensor/LayoutTensor/#copy_from_async)
...
The [`layout_tensor` package](/mojo/layout/layout_tensor/) also includes
