...
[`String`](/mojo/std/collections/string/string/String). But these standard
...
[`Writable`](/mojo/std/format/Writable) trait, which indicates
...
- You can't `print()` a list, or convert it directly into a string.
  ...
  they're a [`Writable`](/mojo/std/format/Writable) type.
...
[`KeyElement`](/mojo/std/collections/dict/#keyelement) trait, and value elements
must conform to the [`Copyable`](/mojo/std/builtin/value/Copyable) trait.
