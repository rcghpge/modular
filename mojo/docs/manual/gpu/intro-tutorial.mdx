...
environment](/mojo/requirements/#gpu-compatibility) to compile kernel functions, otherwise
...
<ListingCards>
  <ListingCard title="Introduction to layouts"
    url="/mojo/manual/layout/layouts"
