...
- [`shuffle_up(value, delta)`](/mojo/std/gpu/primitives/warp/shuffle_up):
...
- [`shuffle_down(value, delta)`](/mojo/std/gpu/primitives/warp/shuffle_down):
...
- [`shuffle_idx(value, src_lane)`](/mojo/std/gpu/primitives/warp/shuffle_idx):
