...
post:
[What ownership is really about: a mental model approach](https://www.modular.com/blog/what-ownership-is-really-about-a-mental-model-approach),
and
...
[`UnsafePointer`](/mojo/std/memory/unsafe_pointer/UnsafePointer) API.
