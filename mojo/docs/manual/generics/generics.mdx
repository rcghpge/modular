...
With those requirements, this updated function walks both lists element by element,
just like the integer version:
...
their traits. See [reflection](/mojo/manual/reflection).
