...
The [`UnsafePointer`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2) type
...
[`init_pointee_copy()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#init_pointee_copy)
and [`init_pointee_move()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#init_pointee_move)
methods. For example:
...
The
[`take_pointee()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#take_pointee)
...
The [`destroy_pointee()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#destroy_pointee)
...
The [`move_pointee_into(self, dst)`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#move_pointee_into)
...
Calling [`free()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#free) on a
...
(for example, using
[`destroy_pointee()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#destroy_pointee) or
...
`MutAnyOrigin`—indicating a pointer that could reference anything in the
current scope.
...
[`load()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#load) and
[`store()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#store) methods for
...
[`strided_load()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#strided_load)
and
[`strided_store()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#strided_store)
...
The [`gather()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#gather) and
[`scatter()`](/mojo/stdlib/memory/unsafe_pointer/UnsafePointerV2#scatter) methods
