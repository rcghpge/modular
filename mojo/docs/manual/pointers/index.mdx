...
- [`Pointer`](/mojo/std/memory/pointer/Pointer) is a safe pointer that points
  to a single value that it doesn't own.

- [`OwnedPointer`](/mojo/std/memory/owned_pointer/OwnedPointer) is a smart
...
- [`UnsafePointer`](/mojo/std/memory/unsafe_pointer/UnsafePointer) points to
...
The [`Pointer`](/mojo/std/memory/pointer/Pointer) type is a safe pointer that
...
The [`OwnedPointer`](/mojo/std/memory/owned_pointer/OwnedPointer) type is a
...
An [`ArcPointer`](/mojo/std/memory/arc_pointer/ArcPointer) is a
...
struct SharedDict(Copyable):
    ...
    def __setitem__(mut self, key: String, value: String) raises:
...
[`Atomic`](/mojo/std/os/atomic/Atomic)
...
[`UnsafePointer`](/mojo/std/memory/unsafe_pointer/UnsafePointer) is a
