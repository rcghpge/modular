...
[Compile-time evaluation](/mojo/manual/metaprogramming/comptime-evaluation/).
...
[Parameters](/mojo/manual/parameters/index/).
...
parameterized on _types_.

  A _trait_ defines a set of shared behaviors for structs. Generic code uses
  ...
  on [traits](/mojo/manual/traits/) and
  [generics](/mojo/manual/generics/generics/).
