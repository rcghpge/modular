...
[Intro to custom ops](/max/develop/custom-ops/).
...
instances of
[`OutputTensor`](/mojo/kernels/extensibility/tensor/managed_tensor_slice/#comptime-values)
and
[`InputTensor`](/mojo/kernels/extensibility/tensor/managed_tensor_slice/#comptime-values),
...
[`IndexList`](/mojo/std/utils/index_/IndexList/) specifying the dimensions of
the output tensor.
