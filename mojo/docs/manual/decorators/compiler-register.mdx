...
instances of
[`OutputTensor`](/mojo/kernels/extensibility/tensor/managed_tensor_slice/#aliases) and
[`InputTensor`](/mojo/kernels/extensibility/tensor/managed_tensor_slice/#aliases),
