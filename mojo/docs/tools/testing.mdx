...
[`TestSuite`](/mojo/std/testing/suite/TestSuite) struct from the standard
...
[`TestSuite`](/mojo/std/testing/suite/TestSuite) struct for automatic test
...
The Mojo standard library includes a [`testing`](/mojo/std/testing/testing/)
...
- [`assert_true()`](/mojo/std/testing/testing/assert_true):
  Asserts that the input value is `True`.
- [`assert_false()`](/mojo/std/testing/testing/assert_false):
...
- [`assert_almost_equal()`](/mojo/std/testing/testing/assert_almost_equal):
...
[`assert_raises()`](/mojo/std/testing/testing/assert_raises), to assert that
...
[`testing`](/mojo/std/testing/testing/) module to implement your tests.
...
[`TestSuite.discover_tests()`](/mojo/std/testing/suite/TestSuite#discover_tests)
