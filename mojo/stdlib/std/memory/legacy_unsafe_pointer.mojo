...
struct LegacyUnsafePointer[
    ...
    *,
    ...
    fn __init__(
        out self,
        other: UnsafePointer[Self.type, address_space=Self.address_space, ...],
    ):
        """Implicitly cast an `UnsafePointer` to a `LegacyUnsafePointer`.
    ...
    fn load[
        ...
        *,
        ...
        Parameters:
            ...
            nontemporal: Whether the load has no temporal locality (streaming).
        ...
        comptime if is_nvidia_gpu() and size_of[
            ...
            for i in range(width):
                v[i] = __mlir_op.`pop.load`[
                    ...
                    isNonTemporal=nontemporal._mlir_value,
                ]((self + i).address)
            return v
    ...
    fn store[
        ...
        *,
        ...
        Parameters:
            ...
            alignment: The minimal alignment of the address.
            volatile: Whether the operation is volatile or not.
            nontemporal: Whether the store has no temporal locality (streaming).
        ...
        """
        (self + offset).store[
            alignment=alignment, volatile=volatile, nontemporal=nontemporal
        ](val)
