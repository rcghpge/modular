...
[Access Tokens](https://huggingface.co/settings/tokens). You can request model
access through the
[Gemma 3 Hugging Face model repository](https://huggingface.co/google/gemma-3-12b-it).
