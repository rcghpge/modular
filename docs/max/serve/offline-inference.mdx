...
github_url: https://github.com/modular/modular/blob/main/max/examples/offline-inference/basic.py
---
...
as kwargs to
[`MAXModelConfig`](/max/api/python/generated/max.pipelines.MAXModelConfig),
and runtime settings such as
...
to use a different model, see our [supported models](/max/models/). This example uses
