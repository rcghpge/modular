...
[`max_batch_input_tokens`](/max/api/python/generated/max.pipelines.lib.PipelineRuntimeConfig#max.pipelines.lib.PipelineRuntimeConfig.max_batch_input_tokens)
to
