...
datacenter-grade GPU, such as **NVIDIA B200 / H200 / H100** or **AMD MI355X /
MI325X / MI300X**. You do have the option to follow along on consumer-grade
systems (including Macs)—just expect fewer compatible models and slower performance.
...
[`max serve`](/max/cli/serve). Choose whether you want **text-to-text** or
**image-to-text (multimodal)** inference by switching tabs below, then use the
dropdown to select a model that fits your hardware's memory constraints.
