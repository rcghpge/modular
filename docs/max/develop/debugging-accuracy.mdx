...
If you also enable
[`source-tracebacks`](/max/develop/debugging-tracing#map-ops-to-python-source),
...
- [Trace op execution](/max/develop/debugging-tracing): See which ops
  MAX runs and map them back to Python source.
- [Debug GPU errors](/max/develop/debugging-gpu): Force synchronous GPU
  dispatch and enable kernel-level bounds checking.
- [Diagnose runtime errors](/max/develop/debugging-errors): Capture
