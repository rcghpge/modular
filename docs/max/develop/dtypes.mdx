...
The [`DType`](/max/api/python/generated/max.dtype.DType) enum in MAX provides all supported data types:
...
In this example, the [`ones()`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.ones) function creates a tensor filled with ones, and
the [`Tensor()`](/max/api/python/generated/max.experimental.tensor.Tensor) constructor creates a tensor from the given values. The
...
Every tensor has a [`dtype`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.dtype) property that returns its data type:
...
The [`cast()`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.cast) method is used to convert a tensor from one dtype to another. This
...
For more information, see the [DType API reference](/max/api/python/generated/max.dtype.DType).
...
In this example, the [`from_dlpack()`](/max/api/python/generated/max.experimental.tensor.Tensor#max.experimental.tensor.Tensor.from_dlpack) method converts the NumPy array to a MAX tensor.
...
The [`torch_dtype_to_max()`](/max/api/python/generated/max.experimental.torch.torch_dtype_to_max) function converts a PyTorch dtype to a MAX dtype. For example:
...
- [`to_numpy()`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.to_numpy): Convert a MAX dtype to a NumPy dtype.
- [`max_dtype_to_torch()`](/max/api/python/generated/max.experimental.torch.max_dtype_to_torch): Convert a MAX dtype to a PyTorch dtype.

## Memory optimization

Understanding dtype memory usage is critical for deploying large models. The
[`size_in_bytes`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.size_in_bytes) property lets you calculate exact memory requirements.
