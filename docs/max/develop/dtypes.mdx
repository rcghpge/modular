...
The [`from_torch()`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.from_torch) method converts a PyTorch dtype to a MAX dtype. For example:
...
- [`to_torch()`](/max/api/python/generated/max.dtype.DType#max.dtype.DType.to_torch): Convert a MAX dtype to a PyTorch dtype.
