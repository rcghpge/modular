...
of
[`InputTensor`](/max/api/kernels/extensibility/managed_tensor_slice/#inputtensor)
and
[`OutputTensor`](/max/api/kernels/extensibility/managed_tensor_slice/#outputtensor),
...
[`@compiler.register_shape_function()`](/max/api/mojo-decorators/compiler-register):
