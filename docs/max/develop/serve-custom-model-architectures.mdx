...
serve` command (explore our [supported models](/max/models/)). You can also use MAX to
...
do [text
generation](/max/api/python/generated/max.interfaces.PipelineTask#max.interfaces.PipelineTask.TEXT_GENERATION),
