...
[`Tensor`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor) like
...
You can create a tensor from a Python list using the [`Tensor.constant()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.constant) function:
...
This imports the [`Tensor`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor) class and
...
such as [`ones()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.ones)
and [`zeros()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.zeros):
...
For random data, you can use one of several functions from the [`random`](/max/api/python/experimental/random) module,
such as [`random.normal()`](/max/api/python/experimental/random#max.experimental.random.normal):
...
In this example, the [`shape`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.shape)
...
The [`num_elements()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.num_elements) function returns the total number of elements in the
