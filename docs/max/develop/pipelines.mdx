...
- **Core modules**: [`Module`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.Module), [`Linear`](/max/api/python/nn/linear#max.nn.linear.Linear), [`Embedding`](/max/api/python/nn/module_v3/Embedding#max.nn.module_v3.Embedding), [`Sequential`](/max/api/python/nn/module_v3/sequential#max.nn.module_v3.sequential.Sequential), [`ModuleList`](/max/api/python/nn/module_v3/sequential#max.nn.module_v3.sequential.ModuleList).
- **Normalization**: [`RMSNorm`](/max/api/python/nn/module_v3/norm/RMSNorm#max.nn.module_v3.norm.RMSNorm), [`GemmaRMSNorm`](/max/api/python/nn/module_v3/norm/GemmaRMSNorm#max.nn.module_v3.norm.GemmaRMSNorm).
- **Positional encodings**: [`RotaryEmbedding`](/max/api/python/nn/module_v3/rope/RotaryEmbedding#max.nn.module_v3.rope.RotaryEmbedding), [`TransposedRotaryEmbedding`](/max/api/python/nn/module_v3/rope/TransposedRotaryEmbedding#max.nn.module_v3.rope.TransposedRotaryEmbedding).
- **Utilities**: [`module_dataclass`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.module_dataclass) for creating module dataclasses.
...
The [`Module`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.Module) base class standardizes how
...
architecture using the [`Module`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.Module) class.
...
1. **Define your model**: You create a
   [`Module`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.Module) that defines your model
   architecture. The module's
   [`forward`](/max/api/python/nn/module_v3/module#max.nn.module_v3.module.Module.forward) method defines what
