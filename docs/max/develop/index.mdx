...
This page provides a brief tour of the process to bring a pretrained model from
Hugging Face to MAX so you can take it into production.
...
and [Build an MLP block as a module](/max/develop/build-an-mlp-block/).
