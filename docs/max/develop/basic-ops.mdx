...
- **Tensor methods**: Call operations directly on [`Tensor`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor) objects, like
...
The [`reshape()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.reshape) method
...
The [`transpose()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.transpose) method
...
[`permute()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.permute) to specify a
new order for all dimensions. This is useful for converting between different
layout conventions. In the following example,
[`permute(0, 2, 1)`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.permute)
...
- [`sum()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.sum): Sum of elements (tensor method)
- [`mean()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.mean): Average of elements (tensor method)
- [`max()`](/max/api/python/experimental/tensor#max.experimental.tensor.Tensor.max): Maximum value (tensor method)
...
[`random.uniform()`](/max/api/python/experimental/random#max.experimental.random.uniform)
generates values uniformly distributed between `low` and `high`, while
[`random.normal()`](/max/api/python/experimental/random#max.experimental.random.normal) generates values
...
[`random.xavier_uniform()`](/max/api/python/experimental/random#max.experimental.random.xavier_uniform)
and [`random.kaiming_uniform()`](/max/api/python/experimental/random#max.experimental.random.kaiming_uniform)
