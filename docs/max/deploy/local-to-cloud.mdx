...
(A10G) on AWS, `g2-standard-8` (L4) on GCP, and `Standard_NV36ads_A10_v5` (A10G)
on Azure. It has also been tested on the AMD `Standard_ND96isr_MI300X_v5`
(MI300X) Azure instance. You can alter the provided cloud config files to deploy
MAX on any
