...
Explore our [supported models](/max/models/) to select the best model for your
use case.

## Endpoint

You can interact with a multimodal LLM through the
[`v1/chat/completions`](/max/rest-api/#POST/v1/chat/completions) endpoint
...
GPU](/max/packages#gpu-compatibility) with >96 GiB of GPU RAM.
...
Serve API documentation](/max/rest-api/).
