...
The [`v1/chat/completions`](/max/rest-api/#POST/v1/chat/completions)
...
The [`v1/completions`](/max/rest-api/#POST/v1/completions) endpoint is
...
The [`v1/completions`](/max/rest-api/#POST/v1/completions) endpoint
...
models listed in our [supported models](/max/models/). Make sure that the model
