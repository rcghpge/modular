...
Distilled FLUX.2-Klein models are an exception: they're trained for exactly 4
steps and reject any other value, so set `steps` to 4 for those models.
Non-distilled Klein variants accept other step counts.
